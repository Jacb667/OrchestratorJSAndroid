...
public class SocketIOClient {
	...
	public static final String HEARTBEAT_INTENT = "HEARTBEAT_INTENT";
        ...
        mClient = new WebSocketClient(new URI(mURL + "websocket/" + mSession), new WebSocketClient.Listener() {
            ...
            public void onMessage(String message) {
                try {
                    ...
                    OrchestratorJsActivity.sendHeartbeatIntent();
                    ...
                    case 2:
                        // heartbeat
                        mClient.send("2::");
                        //MainActivity.sendHeartbeatIntent();
                        break;
                    case 3: {
                        // message

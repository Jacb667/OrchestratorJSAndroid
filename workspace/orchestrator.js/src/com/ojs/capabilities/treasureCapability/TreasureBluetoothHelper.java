...
public class TreasureBluetoothHelper {
    ...
    public TreasureBluetoothHelper(Context applicationContext)
    {
    	TreasureBluetoothHelper.applicationContext_ = applicationContext;
	...
	public void updateProximity(int time)
	{
		...
		timer = new Timer();
		timer.schedule(updateBT, 0, time);
	}
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action))
            {
                ...
                {
                	TreasureCapability.setTargetRSSI(RSSI);
                }
            }
        }
    };

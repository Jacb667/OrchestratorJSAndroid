...
public class CapabilitySettingsActivity extends PreferenceActivity {
	...
	protected void onPostCreate(Bundle savedInstanceState) {
		...
		tempPort = SettingHelpers.getStringValue("orchestrator_port", this);
		CapabilitySettingsActivity.CAPABILITY_LIST_URI = "http://"+temphost+":"+tempPort+"/api/1/capability";
